const products = [
    { 
        id: 'product1',
        url: 'http://localhost:3000/mymockup.jpg', 
    ...
    { 
        id: 'product2',
        url: 'http://localhost:3000/prd1.png', 
        ...
        description: 'Hazrat_Hazrat_Hazrat Here comes the next one in the series, taking you to the gritty world of Gangs of Wasseypur  Feast your eyes on this epic book cover designed by fiery_ash013 which will make you say "Beta, humse na ho payega as it tells the timeless tale of power and vengeance in Wasseypur if the cult classic was released as a book first',
        tagline: 'Politics Drama' 
    },
    { 
        id: 'product3',
        url: 'http://localhost:3000/prd2.png', 
        ...
        title: {
            ...
            longTitle: 'Book Cover inspired by ZINDAGI NA MILEGI DOBARA (FARHAN AKHTAR)'
        }, 
        price: {
            mrp: 499,
            cost: 166,
    ...
    { 
        id: 'product5',
        url: 'http://localhost:3000/prd3.png',
        ...
        description: 'Kala aadmi ko bohot kuch deti hai, lekin TDS bhi kaat leti hai Next up in our series is the cover of the tale that the audience couldnt peel their eyes off of- Andhadhun, if it was released as a book first The cover which is just as eye catching as the movie was, is designed by',
        discount: 'From ₹499', 
        tagline: 'Thriller' 
    },
   { 
        id: 'product6',
        url: 'http://localhost:3000/prd5.jpg', 
        detailUrl: 'https://rukminim1.flixcart.com/image/416/416/kll7bm80/smartwatch/c/1/n/43-mo-sw-sense-500-android-ios-molife-original-imagyzyycnpujyjh.jpeg?q=70',
        title: {
            shortTitle: 'T-SHIRT',
    ...
    { 
        id: 'product7',
        url: 'https://scontent.fdel29-1.fna.fbcdn.net/v/t1.6435-9/90988801_1272124372992134_550139968647856128_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=810d5f&_nc_ohc=5_2nHK0889YAX-7QGw8&_nc_ht=scontent.fdel29-1.fna&oh=00_AfAA1bOMVN2o_1M5tUQusbk6dTqYwwYsuj4it58WrKXLkA&oe=650314F8', 
        detailUrl: 'https://rukminim1.flixcart.com/image/416/416/kll7bm80/smartwatch/c/1/n/43-mo-sw-sense-500-android-ios-molife-original-imagyzyycnpujyjh.jpeg?q=70',
        title: {
            shortTitle: 'STICKER',
     ...
     { 
        id: 'product7',
        url: 'https://scontent.fdel29-1.fna.fbcdn.net/v/t1.6435-9/89850229_1263992873805284_4830280754074222592_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=810d5f&_nc_ohc=SUnnXl7ddqwAX8rGEYH&_nc_ht=scontent.fdel29-1.fna&oh=00_AfC0j5AVSG6-2Uhpyda7wzz7wCcxxtrGlo5Wpw9zsIBhGA&oe=65032F83', 
        detailUrl: 'https://rukminim1.flixcart.com/image/416/416/kll7bm80/smartwatch/c/1/n/43-mo-sw-sense-500-android-ios-molife-original-imagyzyycnpujyjh.jpeg?q=70',
        title: {
            shortTitle: 'STICKER',
